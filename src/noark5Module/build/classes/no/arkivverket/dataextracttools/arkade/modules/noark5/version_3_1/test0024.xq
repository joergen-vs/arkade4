...
(:
 ...
 :
 : Test 24 i versjon 14 av testoppleggsdokumentet.
 : Antall dokumentbeskrivelser uten dokumentobjekt i arkivstrukturen.
 : Type: Analyse
 : Opptelling av antall forekomster av dokumentbeskrivelse uten dokumentobjekt i arkivstruktur.xml.
 : Resultatet vises fordelt på arkivdel.
 : Element: dokumentbeskrivelse
 :)
    ...
    <resultItems>
      <resultItem name="overordnetResultat">
        <resultItems>
          ...
          let $antallUtenDokumentobjekt := count($arkivdel//n5a:registrering/n5a:dokumentbeskrivelse[not(n5a:dokumentobjekt)])
          return
          <resultItem name="arkivdel" type="info">
            <identifiers>
              <identifier name="systemID" value="{$arkivdel/n5a:systemID/normalize-space()}"/> 
            </identifiers>  
            <label>Antall dokumentbeskrivelser uten dokumentobjekt</label>
            <content>{$antallUtenDokumentobjekt}</content>
          </resultItem>
          )
          }
        </resultItems>
