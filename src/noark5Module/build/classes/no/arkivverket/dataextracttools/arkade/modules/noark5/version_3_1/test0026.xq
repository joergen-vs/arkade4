...
(:
 ...
 :
 : Test 26 i versjon 14 av testoppleggsdokumentet.
 : Antall dokumentobjekter i arkivstrukturen.
 : Type: Analyse
 : Opptelling av antall forekomster av dokumentobjekt i arkivstruktur.xml.
      ...
      <resultItem name="overordnetResultat">
        <resultItems>
          ...
          <resultItem name="arkivdel" type="info">
            ...
            <label>Antall dokumentobjekter</label>
