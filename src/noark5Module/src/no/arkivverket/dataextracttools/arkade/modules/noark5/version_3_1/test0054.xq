...
(:
 ...
 : @author Riksarkivet 
 :
 : Test 54 i versjon 14 av testoppleggsdokumentet.
 : Start- og sluttdato for journalpostene i løpende journal.
 : Type: Analyse
 : Angivelse av laveste og høyeste verdi i elementet journaldato i loependeJournal.xml. 
      ...
      <resultItem name="overordnetResultat">
        <resultItems>
          ...
          <resultItem type="{if ($minJournaldato castable as xs:date)
            ...
            <label>Laveste journaldato i løpende journal</label>
          ...
          <resultItem type="{if ($maxJournaldato castable as xs:date)
            ...
            <label>Høyeste journaldato i løpende journal</label>
