...
(:
 ...
 :
 : Test 7 i versjon 14 av testoppleggsdokumentet.
 : Antall klassifikasjonssystemer i arkivstrukturen.
 : Type: Analyse
 : Opptelling av antall forekomster av klassifikasjonssystem i arkivstruktur.xml.
      ...
      <resultItem name="overordnetResultat">
        <resultItems>
          ...
          (
            ...
            return 
          <resultItem name="arkivdel" type="{if ($arkivdel/n5a:klassifikasjonssystem)
                                             then ('info')
                                             else ('warning')}">
            <identifiers>
              <identifier name="systemID" value="{$arkivdel/n5a:systemID/normalize-space()}"/> 
            </identifiers>
            <label>Antall klassifikasjonssystemer</label>
            <content>{count($arkivdel/n5a:klassifikasjonssystem)}</content>
          </resultItem>
          )
          }
        </resultItems>
